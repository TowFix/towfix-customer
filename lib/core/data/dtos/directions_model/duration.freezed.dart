...
/// @nodoc
abstract class _$$_DurationCopyWith<$Res> implements $DurationCopyWith<$Res> {
  factory _$$_DurationCopyWith(
          _$_Duration value, $Res Function(_$_Duration) then) =
      __$$_DurationCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({String? text, int? value});
}
...
/// @nodoc
class __$$_DurationCopyWithImpl<$Res>
    extends _$DurationCopyWithImpl<$Res, _$_Duration>
    implements _$$_DurationCopyWith<$Res> {
  __$$_DurationCopyWithImpl(
      _$_Duration _value, $Res Function(_$_Duration) _then)
      : super(_value, _then);
...
class _$_Duration implements _Duration {
  _$_Duration({this.text, this.value});

  factory _$_Duration.fromJson(Map<String, dynamic> json) =>
      _$$_DurationFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_DurationCopyWith<_$_Duration> get copyWith =>
      __$$_DurationCopyWithImpl<_$_Duration>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_DurationToJson(
      this,
    );
  }
}
...
abstract class _Duration implements Duration {
  factory _Duration({final String? text, final int? value}) = _$_Duration;
